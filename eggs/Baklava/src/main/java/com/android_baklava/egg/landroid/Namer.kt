...
class Namer(resources: Resources) {
    private val planetDescriptors = Bag(resources.getStringArray(R.array.baklava_planet_descriptors))
    private val lifeDescriptors = Bag(resources.getStringArray(R.array.baklava_life_descriptors))
    private val anyDescriptors = Bag(resources.getStringArray(R.array.baklava_any_descriptors))
    private val atmoDescriptors = Bag(resources.getStringArray(R.array.baklava_atmo_descriptors))

    private val planetTypes = Bag(resources.getStringArray(R.array.baklava_planet_types))
    private val constellations = Bag(resources.getStringArray(R.array.baklava_constellations))
    private val constellationsRare = Bag(resources.getStringArray(R.array.baklava_constellations_rare))
    private val suffixes = Bag(resources.getStringArray(R.array.baklava_star_suffixes))
    private val suffixesRare = Bag(resources.getStringArray(R.array.baklava_star_suffixes_rare))
    ...
    private var activities = Bag(resources.getStringArray(R.array.baklava_activities))
    private var floraGenericPlurals = Bag(resources.getStringArray(R.array.baklava_flora_generic_plurals))
    private var faunaGenericPlurals = Bag(resources.getStringArray(R.array.baklava_fauna_generic_plurals))
    private var atmoGenericPlurals = Bag(resources.getStringArray(R.array.baklava_atmo_generic_plurals))
