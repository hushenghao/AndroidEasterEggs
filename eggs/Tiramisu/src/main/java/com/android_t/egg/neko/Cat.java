...
public class Cat extends Drawable {
    ...
    public static final String GLOBAL_SHORTCUT_ID = "com.android_t.egg.neko:allcats";
    public static final String SHORTCUT_ID_PREFIX = "com.android_t.egg.neko:cat:";
    ...
    public Cat(Context context, long seed) {
        ...
        setName(context.getString(R.string.t_default_cat_name,
        ...
        String[] messages = context.getResources().getStringArray(
                nsr.nextFloat() < 0.1f ? R.array.t_rare_cat_messages : R.array.t_cat_messages);
...
//        extras.putString("android.substName", context.getString(R.string.t_notification_name));
        ...
        return new Notification.Builder(context, NekoLand.CHAN_ID)
                .setSmallIcon(Icon.createWithResource(context, R.drawable.t_stat_icon))
                .setLargeIcon(notificationIcon)
                .setColor(getBodyColor())
                .setContentTitle(context.getString(R.string.t_notification_title))
                .setShowWhen(true)
                ...
                .setSubText(context.getString(R.string.t_notification_name));
//                .addExtras(extras);
    }
...
//        MetricsLogger.histogram(context, prefix + "_feet", mFootType);
    ...
    public static class CatParts {
        ...
        public CatParts(Context context) {
            body = context.getDrawable(R.drawable.t_body);
            head = context.getDrawable(R.drawable.t_head);
            leg1 = context.getDrawable(R.drawable.t_leg1);
            leg2 = context.getDrawable(R.drawable.t_leg2);
            leg3 = context.getDrawable(R.drawable.t_leg3);
            leg4 = context.getDrawable(R.drawable.t_leg4);
            tail = context.getDrawable(R.drawable.t_tail);
            leftEar = context.getDrawable(R.drawable.t_left_ear);
            rightEar = context.getDrawable(R.drawable.t_right_ear);
            rightEarInside = context.getDrawable(R.drawable.t_right_ear_inside);
            leftEarInside = context.getDrawable(R.drawable.t_left_ear_inside);
            faceSpot = context.getDrawable(R.drawable.t_face_spot);
            cap = context.getDrawable(R.drawable.t_cap);
            mouth = context.getDrawable(R.drawable.t_mouth);
            foot4 = context.getDrawable(R.drawable.t_foot4);
            foot3 = context.getDrawable(R.drawable.t_foot3);
            foot1 = context.getDrawable(R.drawable.t_foot1);
            foot2 = context.getDrawable(R.drawable.t_foot2);
            leg2Shadow = context.getDrawable(R.drawable.t_leg2_shadow);
            tailShadow = context.getDrawable(R.drawable.t_tail_shadow);
            tailCap = context.getDrawable(R.drawable.t_tail_cap);
            belly = context.getDrawable(R.drawable.t_belly);
            back = context.getDrawable(R.drawable.t_back);
            rightEye = context.getDrawable(R.drawable.t_right_eye);
            leftEye = context.getDrawable(R.drawable.t_left_eye);
            nose = context.getDrawable(R.drawable.t_nose);
            collar = context.getDrawable(R.drawable.t_collar);
            bowtie = context.getDrawable(R.drawable.t_bowtie);
