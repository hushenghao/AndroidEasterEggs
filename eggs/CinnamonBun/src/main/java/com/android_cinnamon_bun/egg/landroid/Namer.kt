...
package com.android_cinnamon_bun.egg.landroid

import com.android_cinnamon_bun.egg.R
...
class Namer(resources: Resources) {
    private val planetDescriptors = Bag(resources.getStringArray(R.array.cinnamon_bun_planet_descriptors))
    private val lifeDescriptors = Bag(resources.getStringArray(R.array.cinnamon_bun_life_descriptors))
    private val anyDescriptors = Bag(resources.getStringArray(R.array.cinnamon_bun_any_descriptors))
    private val atmoDescriptors = Bag(resources.getStringArray(R.array.cinnamon_bun_atmo_descriptors))

    private val planetTypes = Bag(resources.getStringArray(R.array.cinnamon_bun_planet_types))
    private val constellations = Bag(resources.getStringArray(R.array.cinnamon_bun_constellations))
    private val constellationsRare = Bag(resources.getStringArray(R.array.cinnamon_bun_constellations_rare))
    private val suffixes = Bag(resources.getStringArray(R.array.cinnamon_bun_star_suffixes))
    private val suffixesRare = Bag(resources.getStringArray(R.array.cinnamon_bun_star_suffixes_rare))
    ...
    private var activities = Bag(resources.getStringArray(R.array.cinnamon_bun_activities))
    private var floraGenericPlurals = Bag(resources.getStringArray(R.array.cinnamon_bun_flora_generic_plurals))
    private var faunaGenericPlurals = Bag(resources.getStringArray(R.array.cinnamon_bun_fauna_generic_plurals))
    private var atmoGenericPlurals = Bag(resources.getStringArray(R.array.cinnamon_bun_atmo_generic_plurals))
