...
import static com.android_s.egg.neko.NekoLand.CHAN_ID;
...
public class Cat extends Drawable {
    ...
    public static final String GLOBAL_SHORTCUT_ID = "com.android_s.egg.neko:allcats";
    public static final String SHORTCUT_ID_PREFIX = "com.android_s.egg.neko:cat:";
    ...
    public Cat(Context context, long seed) {
        ...
        setName(context.getString(R.string.s_default_cat_name,
        ...
        String[] messages = context.getResources().getStringArray(
                nsr.nextFloat() < 0.1f ? R.array.s_rare_cat_messages : R.array.s_cat_messages);
    ...
    public Notification.Builder buildNotification(Context context) {
        ...
        return new Notification.Builder(context, CHAN_ID)
                .setSmallIcon(Icon.createWithResource(context, R.drawable.s_stat_icon))
                .setLargeIcon(notificationIcon)
                .setColor(getBodyColor())
                .setContentTitle(context.getString(R.string.s_notification_title))
                .setShowWhen(true)
...
//        MetricsLogger.histogram(context, prefix + "_feet", mFootType);
    ...
    public static class CatParts {
        ...
        public CatParts(Context context) {
            body = context.getDrawable(R.drawable.s_body);
            head = context.getDrawable(R.drawable.s_head);
            leg1 = context.getDrawable(R.drawable.s_leg1);
            leg2 = context.getDrawable(R.drawable.s_leg2);
            leg3 = context.getDrawable(R.drawable.s_leg3);
            leg4 = context.getDrawable(R.drawable.s_leg4);
            tail = context.getDrawable(R.drawable.s_tail);
            leftEar = context.getDrawable(R.drawable.s_left_ear);
            rightEar = context.getDrawable(R.drawable.s_right_ear);
            rightEarInside = context.getDrawable(R.drawable.s_right_ear_inside);
            leftEarInside = context.getDrawable(R.drawable.s_left_ear_inside);
            faceSpot = context.getDrawable(R.drawable.s_face_spot);
            cap = context.getDrawable(R.drawable.s_cap);
            mouth = context.getDrawable(R.drawable.s_mouth);
            foot4 = context.getDrawable(R.drawable.s_foot4);
            foot3 = context.getDrawable(R.drawable.s_foot3);
            foot1 = context.getDrawable(R.drawable.s_foot1);
            foot2 = context.getDrawable(R.drawable.s_foot2);
            leg2Shadow = context.getDrawable(R.drawable.s_leg2_shadow);
            tailShadow = context.getDrawable(R.drawable.s_tail_shadow);
            tailCap = context.getDrawable(R.drawable.s_tail_cap);
            belly = context.getDrawable(R.drawable.s_belly);
            back = context.getDrawable(R.drawable.s_back);
            rightEye = context.getDrawable(R.drawable.s_right_eye);
            leftEye = context.getDrawable(R.drawable.s_left_eye);
            nose = context.getDrawable(R.drawable.s_nose);
            collar = context.getDrawable(R.drawable.s_collar);
            bowtie = context.getDrawable(R.drawable.s_bowtie);
