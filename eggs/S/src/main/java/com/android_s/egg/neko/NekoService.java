...
import static com.android_s.egg.neko.Cat.PURR;
...
public class NekoService extends JobService {
    ...
    public static int JOB_ID = 42 + Build.VERSION_CODES.S;

    public static int CAT_NOTIFICATION = 1 + Build.VERSION_CODES.S;
    public static int DEBUG_NOTIFICATION = 1234 + Build.VERSION_CODES.S;
    ...
    private static void triggerFoodResponse(Context context) {
        ...
        if (food != 0) {
            ...
            if (rng.nextFloat() <= CAT_CAPTURE_PROB) {
                ...
                final int[] probs = context.getResources().getIntArray(R.array.s_food_new_cat_prob);
    ...
    public static void registerJob(Context context, long intervalMinutes) {
        ...
        if (NekoLand.DEBUG_NOTIFICATIONS) {
            ...
            noman.notify(DEBUG_NOTIFICATION, new Notification.Builder(context)
                    .setSmallIcon(R.drawable.s_stat_icon)
