...
import com.dede.android_eggs.settings_ui.basic.SwitchPref
...
object RetainInRecentsPrefUtil {
    fun isRetainInRecentsEnabled(context: Context): Boolean {
        ...
        return AppSettings.retainInRecents.get(context)
    }
}
...
fun RetainInRecentsPref() {
    SwitchPref(
        state = rememberPrefBoolState(AppSettings.retainInRecents),
