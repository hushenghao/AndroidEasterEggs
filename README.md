...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/hushenghao/AndroidEasterEggs?logo=github&label=GitHub&style=for-the-badge)](https://github.com/hushenghao/AndroidEasterEggs/releases)
...
* **Pgyer** has the Alpha version. Alpha versions contain unfinished features that are not final and could be removed or reworked without notice and may contain bugs.
